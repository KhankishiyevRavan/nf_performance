    ...
    var chartWidget2 = function () {
      ...
      if (jQuery("#chart_widget_2").length > 0) {
        ...
        const chart_widget_2gradientStroke =
          chart_widget_2.createLinearGradient(0, 0, 0, 250);
    ...
    var chartWidget7 = function () {
      ...
      if (jQuery("#chart_widget_7").length > 0) {
        ...
        const chart_widget_7 = document
          ...
          .getContext("2d");
        //generate gradient
        const chart_widget_7gradientStroke =
          chart_widget_7.createLinearGradient(0, 0, 0, 250);
            ...
            datasets: [
              {
                ...
                data: [
                  20, 10, 18, 15, 32, 18, 15, 22, 8, 6, 12, 13, 10, 18, 14, 24,
    ...
    var chartReinitialize = function (selector, notInList = []) {
      ...
      jQuery(selector).each(function () {
        ...
        $.each(attributes, function (i, item) {
          if (
            item != "id" &&
            (notInList.length === 0 || jQuery.inArray(item, notInList) === -1)
          ) {
