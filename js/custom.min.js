var Akademi = (function () {
  ...
  var t = function () {
    ...
    p = function () {
      $(".dlab-load-more").on("click", function (e) {
        ...
        $.ajax({
          ...
          dataType: "html",
          success: function (e) {
            $("#" + a + "Content").append(e), $(".dlab-load-more i").remove();
          },
        });
      });
    },
    C = function () {
      jQuery("#lightgallery ,#lightgallery-2").length > 0 &&
    ...
    k = function () {
      jQuery("#lightgallery-1").length > 0 &&
        ...
        $(".metismenu  li")
          ...
          .each(function (e) {
            if ($("ul", this).length > 0) {
              ...
              $("body").height();
              var l = $("body").width();
              if (jQuery("html").hasClass("rtl")) var i = a + n <= l;
              else var i = a > 0;
              i
    ...
    q = function () {
      if (jQuery(".image-select").length > 0) {
        ...
        e.find("option").each((e, t) => {
          let a = $(t),
            n = a.attr("data-thumbnail");
          n &&
            a.attr(
              "data-content",
              "<img src='%i'/> %s".replace(/%i/, n).replace(/%s/, a.text())
            );
        }),
          e.selectpicker();
      }
    ...
    R = function (e) {
      parseInt($(".header").css("height"), 10),
        $(".navbar-nav .scroll").on("click", function (e) {
          if (
            (e.preventDefault(),
            ...
            var t = parseInt($(this.hash).offset().top, 10),
              a = parseInt($(".header").css("height"), 10);
            $("html, body").animate({ scrollTop: t - a }, 800, function () {});
          }
        }),
        M();
    },
      ...
      if (jQuery(".navbar-nav").length > 0) {
        ...
        jQuery(document).on("scroll", function () {
          ...
          jQuery(".navbar-nav .scroll").each(function () {
            var a = jQuery(this);
            if ((jQuery(a.attr("href")), void 0 != jQuery(this.hash).offset()))
              var n = parseInt(jQuery(this.hash).offset().top, 10);
            else var n = 0;
            n - t <= e &&
